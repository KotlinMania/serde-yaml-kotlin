...
public class SerializeSeq {
    ...
    public fun serialize_element(value: Value) {
        vec.add(value)
    }
...
public class SerializeTupleStruct {
    ...
    public fun serialize_field(value: Value) {
        vec.add(value)
    }
...
public class SerializeTupleVariant(
...
public class SerializeMap {
    ...
    public fun serialize_key(key: Value) {
        nextKey = key
    }
...
public class SerializeStructVariant(
    private val variant: String,
) {
    private val map = Mapping()
