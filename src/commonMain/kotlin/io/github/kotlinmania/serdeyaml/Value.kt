...
// port-lint: source serde_yaml/src/value/mod.rs
...
public sealed class Value : Comparable<Value> {
    ...
    public data class Number(
        val number: io.github.kotlinmania.serdeyaml.Number,
    ) : Value() {
        public constructor(value: Long) : this(
            io.github.kotlinmania.serdeyaml.Number
                .from(value),
        )
        public constructor(value: Double) : this(
            io.github.kotlinmania.serdeyaml.Number
                .from(value),
        )
    ...
    public data class Mapping(
        val mapping: io.github.kotlinmania.serdeyaml.Mapping,
    ) : Value() {
    ...
    public fun asStr(): kotlin.String? =
        when (val u = untag()) {
            is Str -> u.string
            else -> null
        }
    ...
    public fun asSequence(): List<Value>? =
        when (val u = untag()) {
    ...
    public fun asMapping(): io.github.kotlinmania.serdeyaml.Mapping? =
        when (val u = untag()) {
    ...
    public fun asTagged(): TaggedValue? =
        when (this) {
    ...
    public fun into_deserializer(): io.github.kotlinmania.serdeyaml.value.Deserializer =
        io.github.kotlinmania.serdeyaml.value
            .Deserializer(this)
    ...
    public companion object {
        ...
        public fun to_value(value: Any?): Value =
            io.github.kotlinmania.serdeyaml
                .toValue(value)
        ...
        public fun totalCmp(a: Value, b: Value): Int =
            when (a) {
                is Null ->
                    when (b) {
                        is Null -> 0
