...
- **Files Present:** 24/28 (85.7%)
- **Function parity:** 229/642 matched (target 552) — 35.7%
- **Class/type parity:** 60/198 matched (target 161) — 30.3%
- **Combined symbol parity:** 289/840 matched (target 713) — 34.4%
...
| Source | Target | Path |
|--------|--------|------|
| `serde_yaml.lib` | `serdeyaml.Lib` | `serde_yaml/src/lib` |
