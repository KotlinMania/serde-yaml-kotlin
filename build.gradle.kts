...
kotlin {
    ...
    val xcf = XCFramework("SerdeYaml")

    macosArm64 {
        binaries.framework { baseName = "SerdeYaml"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "SerdeYaml"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "SerdeYaml"
        flattenPackage = "io.github.kotlinmania.serdeyaml"
    }

    android {
        namespace = "io.github.kotlinmania.serdeyaml"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "serde-yaml-kotlin", version.toString())

    pom {
        name.set("serde-yaml-kotlin")
        description.set("Kotlin Multiplatform port of dtolnay/serde-yaml - YAML data format for Serde")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/serde-yaml-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/serde-yaml-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/serde-yaml-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/serde-yaml-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleSerdeYamlXCFramework",
    "assembleSerdeYamlDebugXCFramework",
    "assembleSerdeYamlReleaseXCFramework",
    "assembleDebugIosFatFrameworkForSerdeYamlXCFramework",
    "assembleReleaseIosFatFrameworkForSerdeYamlXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForSerdeYamlXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForSerdeYamlXCFramework",
    "assembleDebugMacosFatFrameworkForSerdeYamlXCFramework",
    "assembleReleaseMacosFatFrameworkForSerdeYamlXCFramework",
    "assembleDebugTvosFatFrameworkForSerdeYamlXCFramework",
    "assembleReleaseTvosFatFrameworkForSerdeYamlXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForSerdeYamlXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForSerdeYamlXCFramework",
    "assembleDebugWatchosFatFrameworkForSerdeYamlXCFramework",
    "assembleReleaseWatchosFatFrameworkForSerdeYamlXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForSerdeYamlXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForSerdeYamlXCFramework",
