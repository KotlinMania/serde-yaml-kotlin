...
This file is the quick-reference operating contract for serde-yaml-kotlin. The longer
...
serde-yaml-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`serde_yaml`](https://crates.io/crates/serde_yaml). Upstream Rust is the behavioral oracle while the
