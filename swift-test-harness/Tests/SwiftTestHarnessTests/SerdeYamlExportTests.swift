...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `SerdeYaml.swiftmodule/`
...
//      `import SerdeYaml` above would fail at compile time.
//
//   2. The static archive `libSerdeYaml.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "SerdeYaml" }` and
//      `flattenPackage = "io.github.kotlinmania.serdeyaml"` configuration in
...
//      via the `SerdeYamlLibrary` product.
//
...
final class SerdeYamlExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "SerdeYaml swift module imported cleanly")
    }
}
